        ...
        <div id="tab-category" class="HuiTab">
            ...
            <div class="tabCon">
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="{{ old('course_name') }}" placeholder="" id="course_name" name="course_name">
                    </div>
                    <div class="col-3">
                    </div>
                </div>
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3">
                    ...
                    简介：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <textarea type="text" class="input-text" value="{{ old('description') }}" placeholder="" name="description">{{ old('description') }}</textarea>
                </div>
                <div class="col-3">
                </div>
            </div>
