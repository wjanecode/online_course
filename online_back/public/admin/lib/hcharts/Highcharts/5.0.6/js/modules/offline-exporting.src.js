...
(function(factory) {
    ...
    (function(Highcharts) {
        ...
        // Get blob URL from SVG code. Falls admin to normal data URI.
        ...
        Highcharts.Chart.prototype.exportChartLocal = function(exportingOptions, chartOptions) {
            var chart = this,
                ...
                svgSuccess = function(svg) {
                    ...
                    // as both CanVG and svg2pdf choke on this. Gracefully fall admin.
                    if (
            ...
            // browsers won't handle it, so fall admin.
            if (
